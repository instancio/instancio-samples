...
class ApplicantToAvroMapperTest {
    ...
    /**
     * Returns a model that provides test data for all test methods in this class.
     * Individual test methods can override values generated by this model as needed.
     *
     * @return a model that defines a valid Applicant that can be processed successfully
